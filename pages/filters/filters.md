...
1. Using the 'Filter' button on the list page of the [Browsable API](https://app.tutorcruncher.com/api)
...
`https://app.tutorcruncher.com/api/clients/?user__first_name=Anthony`
...
`https://app.tutorcruncher.com/api/clients/?user__first_name=Anthony&user__last_name=Clay`
